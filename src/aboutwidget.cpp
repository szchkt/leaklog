...
void AboutWidget::showAcknowledgements(bool show)
{
    ...
    *style << QString("h1 { font-size: 13pt; color: #414141; } h2 { font-size: 11pt; color: #414141; } p, a { font-size: %2; color: #9F9F9F; }").arg(font_size);
    ...
    if (!show) {
        ...
        *p << "&copy; 2008&nbsp;&ndash;&nbsp;2023 <span style=\"font-style:italic;\">Mat&uacute;&scaron; Tomlein, Michal Tomlein, Peter Tomlein</span>";
        p->newLine();
        ...
        *(body->paragraph()) << tr("Serbian translation: %1").arg("Srđan Đokić");

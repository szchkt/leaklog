    ...
    : TabbedModifyDialogue(record, parent)
{
    ...
    ModifyCircuitDialogueCompressorsTab * compressors_tab = new ModifyCircuitDialogueCompressorsTab(md_record->parent("parent"), idFieldValue().toString(), this);
    addTab(compressors_tab);

    ModifyCircuitDialogueUnitsTab * units_tab = new ModifyCircuitDialogueUnitsTab(md_record->parent("parent"), idFieldValue().toString(), this);

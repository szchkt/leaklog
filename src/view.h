...
public:
    enum ViewID {
        ...
        Customers,
        Repairs,
        Circuits,                     CustomerSelectable = Circuits,
        TableOfInspections,           CustomerRequired = TableOfInspections,
        OperatorReport,
        ...
        AssemblyRecords,              CircuitRequiredEnd = AssemblyRecords,
                                      ...
                                      CustomerSelectableEnd = AssemblyRecords,
...
protected:
    ...
    QString writeServiceCompanyOrInspectorStamp();

...
protected:
    ...
    void writeCircuitsHeader(const QString &customer_uuid, const QString &circuit_uuid, int cols_in_row, bool show_date_updated, bool show_owner, bool show_notes, bool disused, HTMLTableRow *thead);
    void writeCircuitRow(const QVariantMap &circuit, const QString &customer_uuid, const QString &circuit_uuid, int cols_in_row, bool show_date_updated, bool show_owner, bool show_notes, HTMLTable *table);

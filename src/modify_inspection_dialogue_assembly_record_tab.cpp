...
ModifyInspectionDialogueAssemblyRecordTab::ModifyInspectionDialogueAssemblyRecordTab(int, MDLineEdit * arno_w, MDComboBox * ar_type_w, const QString & customer_id, const QString & circuit_id, QWidget * parent)
...
void ModifyInspectionDialogueAssemblyRecordTab::init()
{
...
const QVariant ModifyInspectionDialogueAssemblyRecordTab::assemblyRecordType()
{
    return ar_type_w->variantValue();
}

const QVariant ModifyInspectionDialogueAssemblyRecordTab::assemblyRecordId()
{
    return arno_w->variantValue();
}

void ModifyInspectionDialogueAssemblyRecordTab::recordTypeChanged()
{
...
void ModifyInspectionDialogueAssemblyRecordTab::loadItemInputWidgets(bool initial)
{
...
void ModifyInspectionDialogueAssemblyRecordTab::save(const QVariant &)
{
...
int ModifyInspectionDialogueAssemblyRecordTab::saveNewItemType(const MTDictionary & dict)
{
    int id = -1;
...
void ModifyInspectionDialogueAssemblyRecordTab::assemblyRecordNumberChanged()
{
